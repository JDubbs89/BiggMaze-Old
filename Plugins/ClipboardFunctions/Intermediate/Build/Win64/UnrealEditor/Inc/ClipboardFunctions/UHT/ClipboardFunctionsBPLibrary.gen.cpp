...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UClipboardFunctionsBPLibrary_CopyText_Statics::Function_MetaDataParams[] = {
		{ "Category", "Clipboard" },
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UClipboardFunctionsBPLibrary_PasteText_Statics::Function_MetaDataParams[] = {
		{ "Category", "Clipboard" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UClipboardFunctionsBPLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UClipboardFunctionsBPLibrary_CopyText, "CopyText" }, // 4226229143
		{ &Z_Construct_UFunction_UClipboardFunctionsBPLibrary_PasteText, "PasteText" }, // 3059199876
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UClipboardFunctionsBPLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UClipboardFunctionsBPLibrary_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "ClipboardFunctionsBPLibrary.h" },
		{ "ModuleRelativePath", "Public/ClipboardFunctionsBPLibrary.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UClipboardFunctionsBPLibrary_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_Users_Jonathan_Warner_OneDrive_Documents_Github_BigMaze_Alpha_0_0_1_UE_5_3_2joust_brigade_Plugins_ClipboardFunctions_Source_ClipboardFunctions_Public_ClipboardFunctionsBPLibrary_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Jonathan_Warner_OneDrive_Documents_Github_BigMaze_Alpha_0_0_1_UE_5_3_2joust_brigade_Plugins_ClipboardFunctions_Source_ClipboardFunctions_Public_ClipboardFunctionsBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UClipboardFunctionsBPLibrary, UClipboardFunctionsBPLibrary::StaticClass, TEXT("UClipboardFunctionsBPLibrary"), &Z_Registration_Info_UClass_UClipboardFunctionsBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClipboardFunctionsBPLibrary), 1320286070U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Jonathan_Warner_OneDrive_Documents_Github_BigMaze_Alpha_0_0_1_UE_5_3_2joust_brigade_Plugins_ClipboardFunctions_Source_ClipboardFunctions_Public_ClipboardFunctionsBPLibrary_h_1554850799(TEXT("/Script/ClipboardFunctions"),
		Z_CompiledInDeferFile_FID_Users_Jonathan_Warner_OneDrive_Documents_Github_BigMaze_Alpha_0_0_1_UE_5_3_2joust_brigade_Plugins_ClipboardFunctions_Source_ClipboardFunctions_Public_ClipboardFunctionsBPLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Jonathan_Warner_OneDrive_Documents_Github_BigMaze_Alpha_0_0_1_UE_5_3_2joust_brigade_Plugins_ClipboardFunctions_Source_ClipboardFunctions_Public_ClipboardFunctionsBPLibrary_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
