...
#include "BMAttributeSetBase.generated.h"
 ...
 */
UCLASS()
class BIGMAZE_ALPHA_0_API BMAttributeSetBase : public UAttributeSet
{
    GENERATED_BODY()
...
protected:
    ...
    // Helper function to proportionally adjust the value of an attributewhen it's associated max attribute changes.
